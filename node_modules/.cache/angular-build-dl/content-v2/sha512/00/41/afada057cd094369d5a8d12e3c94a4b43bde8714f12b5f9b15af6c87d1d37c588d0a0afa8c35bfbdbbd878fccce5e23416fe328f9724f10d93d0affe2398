...
const routes = [
    ...
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-login-login-login-module */ "pages-login-login-login-module").then(__webpack_require__.bind(null, /*! ./pages/login/login/login.module */ "./src/app/pages/login/login/login.module.ts")).then(m => m.LoginPageModule)
    }
];
...
let AppComponent = class AppComponent {
    constructor(platform, statusBar, nativeStorage, router) {
...
module.exports = __webpack_require__(/*! /home/giovanni/Documenti/socialdisco/src/main.ts */"./src/main.ts");
